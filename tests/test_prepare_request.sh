...
build_prepare_req() {
  ...
  jq_args=(
    ...
    --arg predicate_type "https://jfrog.com/evidence/git-commit/v1"
    --arg provider_id "github-actions"
    --arg project_key "demo"
    --arg entity_type "gitCommit"
...
test_prepare_request_entity_subject() {
  ...
  assert_json_equal \
    '{"predicate":{"branch_protection":{},"pull_request_merge":{}},"predicate_type":"https://jfrog.com/evidence/git-commit/v1","project_key":"demo","provider_id":"github-actions","subject":{"entity_id":"abcdef1234567890abcdef1234567890abcdef12","entity_type":"gitCommit","subject_type":"entity"}}' \
    "$req" \
