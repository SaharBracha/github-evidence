...
test_prepare_request_entity_subject() {
  ...
  assert_json_equal \
    '{"predicate":{"pull_request_merge":{}},"predicate_type":"https://jfrog.com/evidence/pull-request-merge/v1","provider_id":"github-actions","subject":{"entity_id":"abcdef1234567890abcdef1234567890abcdef12","entity_type":"gitCommit","subject_type":"entity"}}' \
    "$req" \
