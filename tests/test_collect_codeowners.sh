#!/usr/bin/env bash
# Tests for scripts/branch-protection/collect-codeowners.sh against fixture-driven mock responses.
set -uo pipefail
...
collect_codeowners() {
  MOCK_CURL_FIXTURE="$1" "${REPO_ROOT}/scripts/branch-protection/collect-codeowners.sh"
}
